...
var SchedulePipe = (function (_super) {
    ...
    function SchedulePipe(size, schedule, isNPS) {
        if (isNPS === void 0) { isNPS = false; }
        var _this;
        //SchedulePipe.WT_DATA
        var sizeIndex = isNPS ? 1 : 0, dn = null, od = null, wt = null;
        // Get the DN size and outer diameter
        for (var i = 0, len = SchedulePipe.OD_DATA.length; i < len; i++) {
            var element = SchedulePipe.OD_DATA[i];
        ...
        var pipeData = SchedulePipe.WT_DATA["" + dn];
...
exports.SchedulePipe = SchedulePipe;
